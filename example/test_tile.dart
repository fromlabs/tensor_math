...
void main() {
  ...
  print(new tm.NDArray.generate([1, 5], (index) => index + 1,
      dataType: tm.NDDataType.float32VBlocked).tile([2, 1]).toValue());

  return;

  print(new tm.NDArray.generate([2, 10, 14], (index) => index + 1,
      dataType: tm.NDDataType.float32VBlocked).tile([2, 2, 1]).toValue());

  print(new tm.NDArray.generate([2, 8, 8], (index) => index + 1,
      dataType: tm.NDDataType.float32VBlocked).tile([2, 1, 1]).toValue());
  ...
  // caso full tiled
  print(new tm.NDArray.generate([10, 10, 10, 10], (index) => index + 1,
      dataType: tm.NDDataType.float32VBlocked).tile([1, 1, 3, 1]).toValue());
  // caso full tiled
  print(new tm.NDArray.generate([10, 10, 10, 10], (index) => index + 1,
