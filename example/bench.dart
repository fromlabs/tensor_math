...
/*
        ...
        var b3 = list2[i23];
*/
        result[ir0] = result[ir0];
        result[ir1] = result[ir1];
        result[ir2] = result[ir2];
        result[ir3] = result[ir3];
      }
    }
  }
}
