...
void _reduceDataOld(
  ...
  while (shapeIndex >= 0) {
    if (shapeIndex == sourceDimensions.length) {
      ...
      onValueToReduce(
          sourcePermutedIndexes[shapeIndex],
          sourceDimensionIndexes[sourcePermutedIndexes[shapeIndex]] - 1,
          sourceArray._data[sourceDataIndex],
          blockColumnCount);
    } else {
      var dimension;
      ...
      if (sourceDimensionIndexes[sourcePermutedIndexes[shapeIndex]] <
        ...
        if (shapeIndex < sourceDimensions.length - newReductionAxis.length) {
          ...
          print(
              "targetDataIndexes[targetPermutedIndexes[$shapeIndex]] = $targetDataIndex + ${targetStrides[targetPermutedIndexes[shapeIndex]]}");
        }
        ...
        if (shapeIndex ==
          ...
          print("REDUCE[$targetDataIndex]: $reducedValue");

          // TODO se la riduzione è sull'ultima colonna devo ridurre in un unico step
